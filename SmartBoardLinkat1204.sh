...
sudo -S apt-get install dkms patch libcurl3 libnspr4-0d ; wget http://es.archive.ubuntu.com/ubuntu/pool/main/u/udev/libudev0_175-0ubuntu9_i386.deb ; sudo -S dpkg -i libudev0_175-0ubuntu9_i386.deb | zenity --progress --title "Instal·lació de Notebook i SmartBoard" --text "Instal·lant les dependències necessàries...\n" --width=400 --no-cancel --auto-close --pulsate 2> /dev/null;
#
# Descàrrega del programari Smartboard i Notebook
sudo -S wget http://download-linkat.xtec.cat/d83/Linkat_edu_12.04/PDI/SMART/32bits/smart-notebook11-ubuntu-12.04.3-and-linkat-12.04-32bits.tar.gz | zenity --progress --title "Instal·lació de Notebook i SmartBoard" --text "Descarregant el programari Smartboard i Notebook.\n\nAixò pot trigar uns minuts. Tingueu paciència...\n" --width=400 --no-cancel --auto-close --pulsate 2> /dev/null; 
#
